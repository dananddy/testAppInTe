...
#ifndef TESTAPPINFOTECH_SWIFT_H
#define TESTAPPINFOTECH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TestAppInfoTech",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15TestAppInfoTech11AppDelegate")
...
SWIFT_CLASS("_TtC15TestAppInfoTech13CityDetailsVC")
@interface CityDetailsVC : UIViewController
...
@interface CityDetailsVC (SWIFT_EXTENSION(TestAppInfoTech)) <UIScrollViewDelegate>
- (void)scrollViewDidScroll:(UIScrollView * _Nonnull)scrollView;
@end


SWIFT_CLASS("_TtC15TestAppInfoTech18MainViewController")
...
@interface MainViewController (SWIFT_EXTENSION(TestAppInfoTech)) <UISearchResultsUpdating>
...
@interface MainViewController (SWIFT_EXTENSION(TestAppInfoTech)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC15TestAppInfoTech13SceneDelegate")
...
SWIFT_CLASS("_TtC15TestAppInfoTech15TATableViewCell")
...
SWIFT_CLASS("_TtC15TestAppInfoTech18WeatherDetailsView")
